...
"""Converting target proxy — wraps any Target, applies evasion converters to prompts.
...
class ConvertingTargetProxy(Target):
    """Proxy that applies evasion-converter transformations before sending prompts."""
    ...
    async def send(self, prompt: str) -> str:
        ...
        from probeagent.integrations.converters import apply_converters
